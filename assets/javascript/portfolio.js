...
(function () {
    ...
    $(document).ready(function () {
        var links = [
            {
                name: 'twitter',
                link: 'https://twitter.com/lukahrip'
            },
                
            {
                name: 'github',
                link: 'http://github.com/lukahrip'
            },

            {
                name: 'telegram',
                link: 'https://t.me/lukahrip'
            },
        ];
    ...
    (function () {
        $.getJSON('https://freegeoip.app/json/', function (data) {
            ...
            writeLine(["<span style='font-size: 14px; color: #00aff2;'>Welcome</span>...", "Granting access to <span style='font-size: 14px; color: #06d;'>[lukah.cf]</span>..."], 30, function () {
                ...
                writeLine(["Access granted! <span style='font-size: 14px; color: #0f0;'>[success]</span>", "Welcome back, <i style='color: #0f0'>" +  ((data.ip) ? data.ip : usernames[Math.floor(Math.random()*usernames.length)]) 
                    ...
                    writeLine(["<i style='color: #ec7dd9'>lukah.cf</i>"], 120, 500, function () {
